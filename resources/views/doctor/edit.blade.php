                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="form-group{{ $errors->has('id_especialidad') ? ' has-danger' : '' }}">
                                        ...
                                        <select class="form-control" name="id_especialidad" id="selectEspecialidad">
                                            <option value="{{  $doctor->id_especialidad }}">{{  $doctor->especialidad ? $doctor->especialidad->descripcion : '' }}</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group{{ $errors->has('fecha_nacimiento') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('fecha_nacimiento') ? ' is-invalid' : '' }}"
                                            name="fecha_nacimiento" id="fecha_nacimiento" type="date" value="{{ old('fecha_nacimiento', $doctor->fecha_nacimiento) }}" aria-required="true"/>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group{{ $errors->has('correo') ? ' has-danger' : '' }}">
                                        ...
                                        <input class="form-control{{ $errors->has('correo') ? ' is-invalid' : '' }}"
                                            ...
                                            value="{{ old('correo', $doctor->correo) }}" aria-required="true"/>
                                    </div>
                                </div>
                            </div>
                        </div>
