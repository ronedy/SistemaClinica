            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Nuevas asignacion</h5>
                    </div>
                    @if ($errors->any())
                    <div class="card-body ">
                    ...
                    @endif
                    <form method="post" action="{{ route('asignacionSeguro.store') }}" autocomplete="off" class="form-horizontal">
                        @csrf
                        @method('post')
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group{{ $errors->has('valor_descuento') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('valor_descuento') ? ' is-invalid' : '' }}"
                                            ...
                                            value="{{ old('valor_descuento') }}" aria-required="true" required step="0.01"/>
                                    </div>
                                </div>
                            </div>
                        </div>
