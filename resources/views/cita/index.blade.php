                    ...
                    <form action="{{ route('cita.index') }}" method="get">
                        <div class="row">
                            <div class="form-group col-md-2">
                                ...
                                <input type="date" name="fecha_inicio" value="{{ old('fecha_inicio', $fecha_inicio ?? null)}}">
                            </div>
                            <div class="form-group col-md-2">
                                <label for="fecha_fin">{{__('Fecha fin')}}</label>
                                <input type="date" name="fecha_fin" value="{{ old('fecha_fin', $fecha_fin ?? null)}}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-2">
                                <input type="submit" value="Aplicar filtros" class="btn btn-success btn-sm">
                            </div>
                        </div>
                    </form>
                    @if (session('mensaje'))
