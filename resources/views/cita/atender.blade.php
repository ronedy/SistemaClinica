        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    @endif
                    <form method="post" action="{{ route('cita.guardar-atender', $cita) }}" autocomplete="off" class="form-horizontal">
                        @csrf
                        @method('put')
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input class="form-control" type="text" name="cliente_alfabeta" id="cliente_alfabeta" value="{{  old('cliente_alfabeta', $cita->cliente->alfabeta) }}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label for="cliente_domicilio" class="form-label">Domicilio:</label>
                                            <input type="text" class="form-control" id="cliente_domicilio" name="cliente_domicilio" value="{{  old('cliente_domicilio', $cita->cliente->direccion) }}" />
                                        </div>
                                        <div class="col-md-3">
                                            <label for="cliente_estado_civil">Estado Civil:</label>
                                            <input class="form-control" type="text" name="cliente_estado_civil" id="cliente_estado_civil" value="{{  old('cliente_estado_civil', $cita->cliente->estado_civil) }}" />
                                        </div>
                                        <div class="col-md-3">
                                            <label for="cliente_telefono">Teléfono:</direccion>
                                            <input class="form-control" type="text" name="cliente_telefono" id="cliente_telefono" value="{{  old('cliente_telefono', $cita->cliente->telefono) }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" class="form-control" name="antecedente_medico" id="antecedente_medico" value="{{  old('antecedente_medico', optional($cita->citaAntecedente)->medicos ?? null) }}" />
                                                </div>
                                                <div class="col-md-12">
                                                    <label for="antecedente_quirurgicos">Quirúrgicos:</label>
                                                    <input type="text" class="form-control" name="antecedente_quirurgicos" id="antecedente_quirurgicos" value="{{  old('antecedente_quirurgicos', optional($cita->citaAntecedente)->quirurgicos ?? null) }}" />
                                                </div>
                                                <div class="col-md-12">
                                                    <label for="antecedente_alergicos">Alérgicos:</label>
                                                    <input type="text" class="form-control" name="antecedente_alergicos" id="antecedente_alergicos" value="{{  old('antecedente_alergicos', optional($cita->citaAntecedente)->alergicos ?? null) }}" />
                                                </div>
                                                <div class="col-md-12">
                                                    <label for="antecedente_traumaticos">Traumaticos:</label>
                                                    <input type="text" class="form-control" name="antecedente_traumaticos" id="antecedente_traumaticos" value="{{  old('antecedente_traumaticos', optional($cita->citaAntecedente)->traumaticos ?? null) }}" />
                                                </div>
                                                <div class="col-md-12">
                                                    <label for="antecedente_familiares">Familiares:</label>
                                                    <input type="text" class="form-control" name="antecedente_familiares" id="antecedente_familiares" value="{{  old('antecedente_familiares', optional($cita->citaAntecedente)->familiares ?? null) }}" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-2">
                                                    ...
                                                    <input type="text" class="form-control" name="antecedente_go_g" id="antecedente_go_g" value="{{  old('antecedente_go_g', optional($cita->citaAntecedenteGineicoObstretico)->g ?? null) }}" />
                                                </div>
                                                <div class="col-md-2">
                                                    <label for="antecedente_go_p">P:</label>
                                                    <input type="text" class="form-control" name="antecedente_go_p" id="antecedente_go_p" value="{{  old('antecedente_go_p', optional($cita->citaAntecedenteGineicoObstretico)->p ?? null) }}" />
                                                </div>
                                                <div class="col-md-2">
                                                    <label for="antecedente_go_ab">Ab:</label>
                                                    <input type="text" class="form-control" name="antecedente_go_ab" id="antecedente_go_ab" value="{{  old('antecedente_go_ab', optional($cita->citaAntecedenteGineicoObstretico)->ab ?? null) }}" />
                                                </div>
                                                <div class="col-md-2">
                                                    <label for="antecedente_go_c">C:</label>
                                                    <input type="text" class="form-control" name="antecedente_go_c" id="antecedente_go_c" value="{{  old('antecedente_go_c', optional($cita->citaAntecedenteGineicoObstretico)->c ?? null) }}" />
                                                </div>
                                                <div class="col-md-2">
                                                    <label for="antecedente_go_hv">Hv:</label>
                                                    <input type="text" class="form-control" name="antecedente_go_hv" id="antecedente_go_hv" value="{{  old('antecedente_go_hv', optional($cita->citaAntecedenteGineicoObstretico)->hv ?? null) }}" />
                                                </div>
                                                <div class="col-md-2">
                                                    <label for="antecedente_go_hm">Hm:</label>
                                                    <input type="text" class="form-control" name="antecedente_go_hm" id="antecedente_go_hm" value="{{  old('antecedente_go_hm', optional($cita->citaAntecedenteGineicoObstretico)->hm ?? null) }}" />
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <label for="antecedente_go_menarquia">Menarquía:</label>
                                                    <input type="text" class="form-control" name="antecedente_go_menarquia" id="antecedente_go_menarquia" value="{{  old('antecedente_go_menarquia', optional($cita->citaAntecedenteGineicoObstretico)->menarquia ?? null) }}" />
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="antecedente_go_ciclos">Ciclos:</label>
                                                    <input type="text" class="form-control" name="antecedente_go_ciclos" id="antecedente_go_ciclos" value="{{  old('antecedente_go_ciclos', optional($cita->citaAntecedenteGineicoObstretico)->ciclos ?? null) }}" />
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <label for="antecedente_go_fur">FUR:</label>
                                                    <input type="text" class="form-control" name="antecedente_go_fur" id="antecedente_go_fur" value="{{  old('antecedente_go_fur', optional($cita->citaAntecedenteGineicoObstretico)->fur ?? null) }}" />
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="antecedente_go_fpp">FPP:</label>
                                                    <input type="text" class="form-control" name="antecedente_go_fpp" id="antecedente_go_fpp" value="{{  old('antecedente_go_fpp', optional($cita->citaAntecedenteGineicoObstretico)->fpp ?? null) }}" />
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <label for="antecedente_go_pap">Pap:</label>
                                                    <input type="text" class="form-control" name="antecedente_go_pap" id="antecedente_go_pap" value="{{  old('antecedente_go_pap', optional($cita->citaAntecedenteGineicoObstretico)->pap ?? null) }}" />
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="antecedente_go_ets">ETS:</label>
                                                    <input type="text" class="form-control" name="antecedente_go_ets" id="antecedente_go_ets" value="{{  old('antecedente_go_ets', optional($cita->citaAntecedenteGineicoObstretico)->ets ?? null) }}" />
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="antecedente_go_coitarquia">Coitarquia:</label>
                                                    <input type="text" class="form-control" name="antecedente_go_coitarquia" id="antecedente_go_coitarquia" value="{{  old('antecedente_go_coitarquia', optional($cita->citaAntecedenteGineicoObstretico)->coitarquia ?? null) }}" />
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <label for="antecedente_go_grupo_rh">Grupo Rh:</label>
                                                    <input type="text" class="form-control" name="antecedente_go_grupo_rh" id="antecedente_go_grupo_rh" value="{{  old('antecedente_go_grupo_rh', optional($cita->citaAntecedenteGineicoObstretico)->grupo_rh ?? null) }}" />
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="antecedente_go_no_parejas">No. Parejas:</label>
                                                    <input type="number" class="form-control" name="antecedente_go_no_parejas" id="antecedente_go_no_parejas" min="0" step="1" value="{{  old('antecedente_go_no_parejas', optional($cita->citaAntecedenteGineicoObstretico)->no_parejas ?? null) }}" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-3">
                                                    ...
                                                    <input class="form-control" type="text" name="cp_edad_gestacional" id="cp_edad_gestacional" maxlength="50" value="{{ old('cp_edad_gestacional', optional($cita->citaControlParental)->edad_gestacional ?? '' ) }}" />
                                                </div>
                                                <div class="col-md-3">
                                                    <label for="cp_presion_arterial">Presión arterial (mm/hg):</label>
                                                    <input class="form-control" type="text" name="cp_presion_arterial" id="cp_presion_arterial" maxlength="50" value="{{ old('cp_presion_arterial', optional($cita->citaControlParental)->presion_arterial ?? '' ) }}" />
                                                </div>
                                                <div class="col-md-3">
                                                    <label for="cp_altura_uterina">Altura uterina:</label>
                                                    <input class="form-control" type="text" name="cp_altura_uterina" id="cp_altura_uterina" maxlength="50" value="{{ old('cp_altura_uterina', optional($cita->citaControlParental)->altura_uterina ?? '' ) }}" />
                                                </div>
                                                <div class="col-md-3">
                                                    <label for="cp_presentacion">Preentación:</label>
                                                    <input class="form-control" type="text" name="cp_presentacion" id="cp_presentacion" maxlength="50" value="{{ old('cp_presentacion', optional($cita->citaControlParental)->presentacion ?? '' ) }}" />
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <label for="cp_fcf">FCF:</label>
                                                    <input class="form-control" type="text" name="cp_fcf" id="cp_fcf" maxlength="50" value="{{ old('cp_fcf', optional($cita->citaControlParental)->fcf ?? '' ) }}" />
                                                </div>
                                                <div class="col-md-3">
                                                    <label for="cp_peso">Peso:</label>
                                                    <input class="form-control" type="text" name="cp_peso" id="cp_peso" maxlength="50" value="{{ old('cp_peso', optional($cita->citaControlParental)->peso ?? '' ) }}" />
                                                </div>
                                                <div class="col-md-3">
                                                    <label for="cp_ultrasonido">Ultrasonido:</label>
                                                    <input class="form-control" type="text" name="cp_ultrasonido" id="cp_ultrasonido" maxlength="50" value="{{ old('cp_ultrasonido', optional($cita->citaControlParental)->ultrasonido ?? '' ) }}" />
                                                </div>
                                                <div class="col-md-3">
                                                    <label for="cp_vacunas">Vacunas:</label>
                                                    <input class="form-control" type="text" name="cp_vacunas" id="cp_vacunas" maxlength="50" value="{{ old('cp_vacunas', optional($cita->citaControlParental)->vacunas ?? '' ) }}" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <input class="form-control{{ $errors->has('observacion') ? ' is-invalid' : '' }}" type="text" name="observacion" id="input_observaciones" value="{{ old('observacion', $cita->observacion) }}" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <label for="input_motivo_consulta">Motivo de consulta: (*)</label>
                                    <input class="form-control{{ $errors->has('motivo') ? ' is-invalid' : '' }}" type="text" name="motivo" id="input_motivo_consulta" value="{{ old('motivo', $cita->motivo) }}" />
                                </div>
                            </div>
                            <hr />
                            <div class="card">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <div class="form-group{{ $errors->has('receta') ? ' has-danger' : '' }}">
                                                ...
                                                <textarea class="form-control{{ $errors->has('receta') ? ' is-invalid' : '' }}" name="receta" id="receta" maxlength="200" rows="5" cols="50">{{  old('receta', $cita->receta) }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card-footer ml-auto mr-auto">
                            <button type="submit" class="btn btn-primary">{{ __('Marca cita como completado') }}</button>
                        </div>
                    </form>
                </div>
            </div>
