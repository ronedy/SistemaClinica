                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group{{ $errors->has('hora_citada') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('hora_citada') ? ' is-invalid' : '' }}"
                                            ...
                                            value="{{ old('hora_citada', $cita->hora_citada) }}" aria-required="true" required step="1" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <input class="form-control" type="text" name="observacion" id="input_observaciones" value="{{ old('observacion', $cita->observacion) }}" />
                                </div>
                            </div>
                            <div class="row" style="display: none;">
                                <div class="col-12">
                                    <label for="input_motivo_consulta">Motivo de consulta: (*)</label>
                                    <input class="form-control" type="text" name="motivo" id="input_motivo_consulta" value="{{ old('motivo', $cita->motivo) }}" />
                                </div>
                            </div>
                        </div>
