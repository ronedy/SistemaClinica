        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    @endif
                    <form method="post" action="{{ route('enfermedad.update', $enfermedad) }}" autocomplete="off" class="form-horizontal">
                        @csrf
                        @method('put')
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="form-group{{ $errors->has('descripcion') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('descripcion') ? ' is-invalid' : '' }}"
                                            ...
                                            value="{{ old('descripcion', $enfermedad->descripcion) }}" aria-required="true" required maxlength="100"/>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group{{ $errors->has('sintoma') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('sintoma') ? ' is-invalid' : '' }}"
                                            ...
                                            value="{{ old('sintoma', $enfermedad->sintoma) }}" aria-required="true" required maxlength="100"/>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group{{ $errors->has('receta') ? ' has-danger' : '' }}">
                                        <input class="form-control{{ $errors->has('receta') ? ' is-invalid' : '' }}"
                                            ...
                                            value="{{ old('receta', $enfermedad->receta) }}" aria-required="true" required maxlength="100"/>
                                    </div>
                                </div>
                            </div>
                        </div>
